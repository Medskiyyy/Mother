...
fun ProgressScreen(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedTab) {
            0 -> HabitListScreen(viewModel = habitListViewModel, onStartTimer = onStartTimer, onEditHabit = onEditHabit)
            1 -> StudySessionListScreen(viewModel = studySessionListViewModel, onEditSession = onEditSession)
